...
const AdminPetPage = () => { 
  ...
  const updatePet = async () => { 
    try { 
      await axios.put(`https://localhost:7020/api/pets/${selectedPet.petID}`, updatedPetData); 
        ...
        <div className="update-pet-modal"> 
          <div className="update-pet-modal-content"> 
            ...
            <form> 
              ...
              <button type="button" className="btn btn-secondary" onClick={closeUpdateWindow}> 
                Cancel 
              </button> 
            </form> 
          </div> 
